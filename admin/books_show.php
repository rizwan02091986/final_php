...
$sql = "select books .* , authors.author_name, category.CategoryName from books inner join authors on authors.id = books.AuthId_FK inner join category on category.id = books.Catid_FK";
